...
/*
HardwareTypesApiService (Provider) Gets a specific Hardware Type.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hardwareTypeName (Provider) The Hardware Type name
 * @param optional nil or *HardwareTypesApiGetHardwareTypeOpts - Optional Parameters:
...
func (a *HardwareTypesApiService) GetHardwareType(ctx context.Context, hardwareTypeName string, localVarOptionals *HardwareTypesApiGetHardwareTypeOpts) (HardwareType, *http.Response, error) {
	var (
		...
		localVarReturnValue HardwareType
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/hardware-types/{hardware_type_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"hardware_type_name"+"}", fmt.Sprintf("%v", hardwareTypeName), -1)
...
HardwareTypesApiService (Provider) Gets a specific Hardware Type.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param hardwareTypeId (Provider) The Hardware Type ID
 * @param optional nil or *HardwareTypesApiGetHardwareTypeByIdOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return HardwareType
...
func (a *HardwareTypesApiService) GetHardwareTypeById(ctx context.Context, hardwareTypeId string, localVarOptionals *HardwareTypesApiGetHardwareTypeByIdOpts) (HardwareType, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/resources/hardware-types/{hardware_type_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"hardware_type_id"+"}", fmt.Sprintf("%v", hardwareTypeId), -1)
...
/*
HardwareTypesApiService (Provider) Gets a list of all hardware types.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *HardwareTypesApiListHardwareTypesOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
     * @param "MediaType" (optional.String) -  Return only hardware types matching the given media type
     * @param "ArrayType" (optional.String) -  Return only hardware types matching the given array type
...
func (a *HardwareTypesApiService) ListHardwareTypes(ctx context.Context, localVarOptionals *HardwareTypesApiListHardwareTypesOpts) (HardwareTypeList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue HardwareTypeList
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/hardware-types"
	...
	if localVarOptionals != nil && localVarOptionals.ArrayType.IsSet() {
		localVarQueryParams.Add("arrayType", parameterToString(localVarOptionals.ArrayType.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
