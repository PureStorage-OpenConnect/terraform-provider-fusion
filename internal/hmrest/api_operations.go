 ...
 * @param optional nil or *OperationsApiListOperationsOpts - Optional Parameters:
     ...
     * @param "StartedAt" (optional.Int64) -
     * @param "EndedAt" (optional.Int64) -
...
func (a *OperationsApiService) ListOperations(ctx context.Context, localVarOptionals *OperationsApiListOperationsOpts) (OperationList, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.StartedAt.IsSet() {
		localVarQueryParams.Add("started_at", parameterToString(localVarOptionals.StartedAt.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.EndedAt.IsSet() {
		localVarQueryParams.Add("ended_at", parameterToString(localVarOptionals.EndedAt.Value(), ""))
	}
