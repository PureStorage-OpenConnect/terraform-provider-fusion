...
/*
ArraysApiService (Provider) Registers an array into Pure Fusion.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param regionName The Region name
 * @param availabilityZoneName The Availability Zone name
 * @param optional nil or *ArraysApiCreateArrayOpts - Optional Parameters:
...
func (a *ArraysApiService) CreateArray(ctx context.Context, body ArrayPost, regionName string, availabilityZoneName string, localVarOptionals *ArraysApiCreateArrayOpts) (Operation, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/regions/{region_name}/availability-zones/{availability_zone_name}/arrays"
...
/*
ArraysApiService Deregister a specific array.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param regionName The Region name
 * @param availabilityZoneName The Availability Zone name
 * @param arrayName The Array name
 * @param optional nil or *ArraysApiDeleteArrayOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return Operation
...
func (a *ArraysApiService) DeleteArray(ctx context.Context, regionName string, availabilityZoneName string, arrayName string, localVarOptionals *ArraysApiDeleteArrayOpts) (Operation, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/regions/{region_name}/availability-zones/{availability_zone_name}/arrays/{array_name}"
	localVarPath = strings.Replace(localVarPath, "{"+"region_name"+"}", fmt.Sprintf("%v", regionName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"availability_zone_name"+"}", fmt.Sprintf("%v", availabilityZoneName), -1)
...
/*
ArraysApiService (Provider) Gets a specific Array.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param regionName The Region name
 * @param availabilityZoneName The Availability Zone name
 * @param arrayName The Array name
 * @param optional nil or *ArraysApiGetArrayOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return Array
 ...
 * @param optional nil or *ArraysApiGetArrayByIdOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return Array
...
func (a *ArraysApiService) GetArrayById(ctx context.Context, arrayId string, localVarOptionals *ArraysApiGetArrayByIdOpts) (Array, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/resources/arrays/{array_id}"
...
/*
ArraysApiService (Provider) Gets performance metrics of a specific Array.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param regionName The Region name
 * @param availabilityZoneName The Availability Zone name
 * @param arrayName The Array name
 * @param optional nil or *ArraysApiGetArrayPerformanceOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return Performance
...
func (a *ArraysApiService) GetArrayPerformance(ctx context.Context, regionName string, availabilityZoneName string, arrayName string, localVarOptionals *ArraysApiGetArrayPerformanceOpts) (Performance, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/regions/{region_name}/availability-zones/{availability_zone_name}/arrays/{array_name}/performance"
	localVarPath = strings.Replace(localVarPath, "{"+"region_name"+"}", fmt.Sprintf("%v", regionName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"availability_zone_name"+"}", fmt.Sprintf("%v", availabilityZoneName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"array_name"+"}", fmt.Sprintf("%v", arrayName), -1)
 ...
 * @param availabilityZoneName The Availability Zone name
 * @param arrayName The Array name
 * @param optional nil or *ArraysApiGetArraySpaceOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return Space
...
func (a *ArraysApiService) GetArraySpace(ctx context.Context, regionName string, availabilityZoneName string, arrayName string, localVarOptionals *ArraysApiGetArraySpaceOpts) (Space, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/regions/{region_name}/availability-zones/{availability_zone_name}/arrays/{array_name}/space"
	localVarPath = strings.Replace(localVarPath, "{"+"region_name"+"}", fmt.Sprintf("%v", regionName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"availability_zone_name"+"}", fmt.Sprintf("%v", availabilityZoneName), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"array_name"+"}", fmt.Sprintf("%v", arrayName), -1)
...
/*
ArraysApiService (Provider) Gets a list of all arrays registered to Pure Fusion.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param regionName The Region name
 * @param availabilityZoneName The Availability Zone name
 * @param optional nil or *ArraysApiListArraysOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return ArrayList
...
/*
ArraysApiService Updates a specific array.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param regionName The Region name
 * @param availabilityZoneName The Availability Zone name
 * @param arrayName The Array name
 * @param optional nil or *ArraysApiUpdateArrayOpts - Optional Parameters:
     * @param "XRequestID" (optional.String) -  The Request ID supplied with the request, used to perform operations idempotently.
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint.
     * @param "XCorrelationID" (optional.String) -  The Correlation ID provided will be added to log messages and can be used for support. The same Correlation ID may be used for separate requests, to track a higher level workflow.
@return Operation
